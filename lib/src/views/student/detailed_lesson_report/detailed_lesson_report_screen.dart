...
class DetailedLessonReportScreen extends StatefulWidget {
  const DetailedLessonReportScreen({Key? key}) : super(key: key);

  @override
  State<DetailedLessonReportScreen> createState() =>
      _DetailedLessonReportScreenState();
}

class _DetailedLessonReportScreenState
    extends State<DetailedLessonReportScreen> {
  int selectedItem = 0;
  @override

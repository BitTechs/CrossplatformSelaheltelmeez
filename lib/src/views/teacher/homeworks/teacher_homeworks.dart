...
class TeacherHomeworks extends StatelessWidget {
      ...
      child: Padding(
        ...
        child: Column(
          children: [
            FancyAddButton(
              width: 50.w,
              title: 'إنشاء واجب دراسي',
              onPressed: (){
                Navigator.of(context).pushNamed(RouteNames.teacherAddHomework);
              },
            ),
            SizedBox(height: 4.w,),
            Stack(
            ...
            InkWell(
              onTap: (){
                Navigator.of(context).pushNamed(RouteNames.teacherHomeworkScreen);
              },
              child: Stack(
                    ...
                    children:  [
                      ...
                      Expanded(
                        child: Column(
                          ...
                          children: [
                            Text('تم ارسال واجب دراسي 6 عربي'),
                            SizedBox(height: 2.w,),
                            Text('1/3/2022  03:38',

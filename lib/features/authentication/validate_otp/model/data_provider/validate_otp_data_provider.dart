...
class ValidateOTPDataProvider{
  Future<Response<dynamic>> validateAsync(ValidateOTPRequest request, bool isMobile) async {
  ...
  Future<Response<dynamic>> resendActivationCodeAsync(bool isMobile) async {
    Dio dioClient = await DioClient.getHttpClient();
